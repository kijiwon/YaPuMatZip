...
export default function NavBar() {
  ...
  return (
    <>
      <nav className="hidden lg:flex flex-row justify-center items-end  h-[50px]  pb-[5px] font-paper_logy  border-b-[1.5px] border-gray-200">
        {filteredData.map((i) => (
          <button
            key={i.id}
      ...
      <nav className="fixed lg:hidden mt-[130px]">
        <TbBuildingStadium />
        {filteredData.map((i) => (
          <button
            key={i.id}
